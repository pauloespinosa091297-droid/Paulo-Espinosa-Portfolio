          ...
          <div class="contact-form-wrapper mx-auto">
            <form @submit.prevent="submitForm" id="contactForm">
              <div class="mb-3">
                ...
                <input id="inputname" type="text" class="form-control" placeholder="Juan Dela Cruz" v-model="name">
              </div>

              <div class="mb-3">
                <label class="form-label">Email Address</label>
                <input id="inputemail" type="email" class="form-control" placeholder="juan.delacruz@mail.com" v-model="email">
              </div>

              <div class="mb-4">
                <label class="form-label">Message</label>
                <textarea id="inputmessage" class="form-control" rows="5" placeholder="Leave a message here" v-model="message"></textarea>
              </div>
              ...
              data-bs-target="#successModal" :disabled="isLoading">{{isLoading ? "Sending..." : "Submit"}}</button>
